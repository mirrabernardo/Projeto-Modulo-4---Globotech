...
create table globotech.plataforma (
	...
	nome_plataforma varchar(60) unique
);

-- tabela de conteúdos
create table globotech.conteudo (
	id_conteudo int primary key,
    nome_conteudo varchar(60) unique
);
...
create table globotech.tipointeracao (
	id_tipo_interacao int primary key,
    nome_tipo_interacao varchar(60) unique
);
...
create table globotech.interacao (
    ...
    watch_duration_seconds time null, -- duração opcional, pois só o 'view_start' tem duração
